...
# --- HEADER ---
st.title("🛰️ Event Weather Risk Forecaster")
...
if st.session_state.analysis_done and st.session_state.current_results:
    ...
    if not res['hist_df'].empty:
        ...
        if rain_prob > 50 or hot_prob > 50:
            ...
            is_high_risk = False
            message = "⚠️ **Moderate Risk:** Be aware of potential adverse weather. It is advisable to have a backup plan."
        ...
        if is_high_risk:
            ...
            if res['rain_prob'] > 50:
                ...
                st.warning(f"🌧️ **High Rain Risk:** With a {res['rain_prob']:.0f}% chance of rainy conditions, you might want to consider some drier destinations.")
